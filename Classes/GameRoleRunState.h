...
#ifndef GameRoleRunState_h
#define GameRoleRunState_h

#include <stdio.h>
#include "GameRoleState.h"
#include "DirectionDefine.h"

class GameRoleRunState:public GameRoleState
{
public:
    GameRoleRunState();
    GameRoleRunState(const DirectionTypeDefine& direction);
    virtual ~GameRoleRunState();
