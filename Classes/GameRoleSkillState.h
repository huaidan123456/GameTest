//
//  GameRoleSkillState.h
//  GameTest-mobile
//
//  Created by Allen on 2018/7/9.
//

#ifndef GameRoleSkillState_h
#define GameRoleSkillState_h

#include <stdio.h>
#include <stdio.h>
#include "GameRoleState.h"

class GameRoleSkillState:public GameRoleState
{
public:
    GameRoleSkillState();
    virtual ~GameRoleSkillState();
