//
//  GameRoleAttackState.h
//  GameTest-mobile
//
//  Created by Allen on 2018/7/5.
//

#ifndef GameRoleAttackState_h
#define GameRoleAttackState_h

#include <stdio.h>
#include "GameRoleState.h"

class GameRoleAttackState:public GameRoleState
{
public:
    GameRoleAttackState();
    virtual ~GameRoleAttackState();
