//
//  GameRoleStandState.h
//  GameTest-mobile
//
//  Created by Allen on 2018/7/3.
//

#ifndef GameRoleStandState_h
#define GameRoleStandState_h

#include <stdio.h>
#include "GameRoleState.h"

class GameRoleStandState:public GameRoleState
{
public:
    GameRoleStandState();
    virtual ~GameRoleStandState();
